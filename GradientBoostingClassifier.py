...
Original file is located at
    https://colab.research.google.com/drive/1zL1STK4F34IfvKu8xKSx3_TgxZCzKNtD
"""
...
gbc.fit(qtrain,ytrain)

predy = gbc.predict(qtest)

print(accuracy_score(ytest,predy))

"""From above code we get best activation as logistic and max_iter as 500"""
...
predy=gbc.predict(cpBtestFrame)
