...
rf = RandomForestClassifier(random_state=2019,oob_score=True)
parameters={'n_estimators':[100,200,300,400,500,600],'min_samples_split':[3,4,5,6,7,8,9,10],'min_samples_leaf':[2,3,4,5,6,7,8,9,10]}
cv = GridSearchCV(rf, param_grid=parameters,cv=5,scoring='roc_auc')
...
rf=RandomForestClassifier(random_state=2019,n_estimators=400,min_samples_split=5,min_samples_leaf=2,oob_score=True)
